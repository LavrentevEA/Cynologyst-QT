...
QWidget *BreedDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem &/* option */, const QModelIndex &/* index */) const {
...
void BreedDelegate::setModelData(QWidget *editor, QAbstractItemModel *model, const QModelIndex &index) const {
...
void BreedDelegate::setEditorData(QWidget *editor, const QModelIndex &index) const {
